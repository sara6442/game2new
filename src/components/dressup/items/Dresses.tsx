...
export const Dress3:  React.FC<ClothProps> = makePngDress('/dress3.png',  { x: 2,    y: 276,  scale: 1    })
...
export const Dress13: React.FC<ClothProps> = makePngDress('/dress13.png', { x: -57,  y: 53,   scale: 1.36 })
export const Dress14: React.FC<ClothProps> = makePngDress('/dress14.png', { x: -13,  y: -228, scale: 1.04 })
...
export const Dress17: React.FC<ClothProps> = makePngDress('/dress17.png', { x: 0,    y: 16,   scale: 1    })
...
export const DRESS_ITEMS: DressItem[] = [
  ...
  { id: 'dress3',  name: 'Dress 3',  Component: Dress3,  sleeveLength: 'long',  defaultAlign: { x: 2,    y: 276,  scale: 1    } },
  ...
  { id: 'dress13', name: 'Dress 13', Component: Dress13, sleeveLength: 'long',  defaultAlign: { x: -57,  y: 53,   scale: 1.36 } },
  { id: 'dress14', name: 'Dress 14', Component: Dress14, sleeveLength: 'none',  defaultAlign: { x: -13,  y: -228, scale: 1.04 } },
  ...
  { id: 'dress17', name: 'Dress 17', Component: Dress17, sleeveLength: 'none',  defaultAlign: { x: 0,    y: 16,   scale: 1    } },
