...
export const Face2 = makePngGlasses('/face1.png', { x: 0, y: 0, scale: 1 })
export const Face3 = makePngGlasses('/face1.png', { x: 0, y: 0, scale: 1 })
export const Face4 = makePngGlasses('/face1.png', { x: 0, y: 0, scale: 1 })
export const Face5 = makePngGlasses('/face1.png', { x: 0, y: 0, scale: 1 })
export const Face6 = makePngGlasses('/face1.png', { x: 0, y: 0, scale: 1 })
export const Face8 = makePngGlasses('/face1.png', { x: 0, y: 0, scale: 1 })
export const Face7 = makePngGlasses('/face1.png', { x: 0, y: 0, scale: 1 })
