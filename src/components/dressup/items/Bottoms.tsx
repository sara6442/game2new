...
export const Bottom7: React.FC<ClothProps> = makePngBottom('/bottom7.png', { x: 1, y: 14, scale: 0.98 })
export const Bottom8: React.FC<ClothProps> = makePngBottom('/bottom8.png')
export const Bottom9: React.FC<ClothProps> = makePngBottom('/bottom9.png', { x: 2, y: 5, scale: 0.98 })
...
export const Bottom13: React.FC<ClothProps> = makePngBottom('/bottom13.png', { x: 4, y: 3, scale: 0.98 })
...
export const Bottom15: React.FC<ClothProps> = makePngBottom('/bottom15.png', { x: 4, y: 5, scale: 0.98 })
export const Bottom16: React.FC<ClothProps> = makePngBottom('/bottom16.png', { x: 35, y: 66, scale: 0.8 })
export const Bottom17: React.FC<ClothProps> = makePngBottom('/bottom17.png', { x: 5, y: -2, scale: 0.97 })
export const Bottom19: React.FC<ClothProps> = makePngBottom('/bottom19.png', { x: 11, y: 12, scale: 0.94 })
export const Bottom20: React.FC<ClothProps> = makePngBottom('/bottom20.png', { x: 4, y: 3, scale: 0.98 })
