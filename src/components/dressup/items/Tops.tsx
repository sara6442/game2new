...
export const Top14: React.FC<ClothProps> = makePngTop('/top14.png', { x: -1, y: 2, scale: 1 })
export const Top15: React.FC<ClothProps> = makePngTop('/top15.png', { x: 0, y: 0, scale: 1 })
