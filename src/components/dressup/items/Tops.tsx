...
export const Top14: React.FC<ClothProps> = makePngTop('/top14.png', { x: 29, y: 37, scale: 0.83 })  // ✅ Fixed
export const Top15: React.FC<ClothProps> = makePngTop('/top15.png', { x: 31, y: 52, scale: 0.8 })   // ✅ Fixed
export const Top16: React.FC<ClothProps> = makePngTop('/top16.png', { x: 0, y: 36, scale: 1 })
export const Top17: React.FC<ClothProps> = makePngTop('/top17.png', { x: 28, y: 59, scale: 0.81 })  // ✅ Fixed
...
export const TOP_ITEMS: TopItem[] = [
  ...
  { id: 'top17', name: 'Dotted Top', Component: Top17, sleeveLength: 'long' },  // ✅ Fixed spelling
