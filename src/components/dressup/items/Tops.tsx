...
export const Top14: React.FC<ClothProps> = makePngTop('/top14.png', { x: 23, y: 33, scale: 0.86 })
export const Top15: React.FC<ClothProps> = makePngTop('/top15.png', { x: 28, y: 47, scale: 0.82 })
export const Top16: React.FC<ClothProps> = makePngTop('/top16.png', { x: 0, y: 36, scale: 1 })
export const Top17: React.FC<ClothProps> = makePngTop('/top17.png', { x: 0, y: -34, scale: 1 })
