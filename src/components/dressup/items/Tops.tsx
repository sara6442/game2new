...
export const TOP_ITEMS: TopItem[] = [
  { id: 'top1',  name: 'Tan Poncho',    Component: Top1,  sleeveLength: 'long',  defaultAlign: { x: 0,   y: 0,   scale: 1    } },
  { id: 'top2',  name: 'Maroon Cape',   Component: Top2,  sleeveLength: 'long',  defaultAlign: { x: 0,   y: 0,   scale: 1    } },
  { id: 'top3',  name: 'White Shirt',   Component: Top3,  sleeveLength: 'short', defaultAlign: { x: 0,   y: 0,   scale: 1    } },
  { id: 'top4',  name: 'Cream Blouse',  Component: Top4,  sleeveLength: 'short', defaultAlign: { x: 0,   y: 0,   scale: 1    } },
  { id: 'top5',  name: 'Floral Top',    Component: Top5,  sleeveLength: 'long',  defaultAlign: { x: 0,   y: 0,   scale: 1    } },
  { id: 'top6',  name: 'Ruffled Blouse',Component: Top6,  sleeveLength: 'long',  defaultAlign: { x: 0,   y: 0,   scale: 1    } },
  { id: 'top7',  name: 'Blue Checkered',Component: Top7,  sleeveLength: 'short', defaultAlign: { x: 0,   y: 0,   scale: 1    } },
  { id: 'top9',  name: 'Silk Tank',     Component: Top9,  sleeveLength: 'long',  defaultAlign: { x: 0,   y: 0,   scale: 1    } },
  { id: 'top10', name: 'Denim Jacket',  Component: Top10, sleeveLength: 'long',  defaultAlign: { x: -45, y: 8,   scale: 1.25 } },
